                ...
                <AnimatePresence>
                    {hoveredComponent && (
                        <motion.div
                            ...
                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-48 bg-zinc-900/95 border border-zinc-600 rounded-lg shadow-2xl p-4 backdrop-blur-md z-50 pointer-events-none"
                        >
                            {renderDetailContent()}
                        </motion.div>
                    )}
